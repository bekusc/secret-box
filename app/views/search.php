            ...
            <div class="wide">
                ...
                <div class="secrets-list">
                    ...
                    <?php elseif (isset($query)): ?>
                        ...
                        <div class="page-message">
                            <h3>Stai cercando segreti che contengono "<?= $query ?>"</h3>
                        </div>
                    ...
                    <?php foreach ($articles as $article) : ?>
                        ...
                        <article class="secret <?= $article->gender; ?>">
                            ...
                            <footer>
                                <div class="social">
                                    <a class="comments" data-title="<?= $article->stitle; ?>"><strong><span class="fb-comments-count" data-href="<?= $_SERVER['SERVER_NAME']; ?>/seg/<?= $article->stitle; ?>"></span></strong> commenti</a>
                                    <div class="info">
